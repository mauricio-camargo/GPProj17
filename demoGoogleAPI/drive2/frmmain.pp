...
//  ini:=TIniFile.Create('google.ini');
  try
    ...
    FClient.AuthHandler.Config.ClientID:='502080815718-1r1iseasap01bovrrs35rrq9053sfke9.apps.googleusercontent.com';
    FClient.AuthHandler.Config.ClientSecret:='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';
    FClient.AuthHandler.Config.AuthScope:='https://www.googleapis.com/auth/drive';
...
//    FClient.AuthHandler.Config.AuthScope:=ini.ReadString('Credentials','Scope','https://www.googleapis.com/auth/drive');
    ...
    // Session data
    FClient.AuthHandler.Session.RefreshToken:='1//0hyRR8V5YTQpiCgYIARAAGBESNwF-L9IrLSgBfBBUUlQM5gJZKCLusH9lj20syeit9a_scu8FdyITnCGReJpKUCqZpkPQXq6Jpo0';
    FClient.AuthHandler.Session.AccessToken:='ya29.A0ARrdaM-qhTKbrXnk6oaVjPhLl8EL9gRIbgA48pTtOGraGHrQN5tmODdYCwMhv3hEXs8Xo9dWPJ9wJXlsz5lGOw_3h1hEfa3SdGQkeGw2jfca7YFqzFq7EBcKWjgpQlSkStmOqnBG07eRDwBOFiGnU0G40fuYug';
