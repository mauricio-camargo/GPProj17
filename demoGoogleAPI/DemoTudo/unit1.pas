...
var
  ...
  FPList:TListConnectionsResponse;
  i:integer;
  //people/me
  begin
  Memo3.Lines.Clear;
  Resource:=Nil;
  Resource:=FPeopleAPI.CreatePeopleConnectionsResource;
  ShowMessage(Resource.ResourceName);
...
//        LBTasks.Items.AddObject(IntToStr(i)+': '+EN,Entry);
        if T<>'' then S:=S+IntToStr(n-i+1)+'. '+T+#13;
